...
class RawReadLazy(RawRead):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.cache_size_limit = kwargs.pop('cache_size_limit', 1024 * 1024 * 1024)  # 1GB default
    ...
    def preload_traces(self, trace_names: Union[str, List[str]], steps: Optional[List[int]] = None) -> None:
    ...
    def get_memory_usage(self) -> Dict[str, Any]:
        ...
        stats['cache_usage_percent'] = (
            ...
            if self.cache_size_limit > 0 else 0
        )
