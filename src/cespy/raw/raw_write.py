...
class Trace(DataSet):
    ...
    def __init__(
        self,
        name: str,
        data: Sequence[float | complex] | NDArray[Any],
...
class RawWrite:
    ...
    def add_trace(self, trace: Trace) -> None:
        ...
        elif len(self._traces[0]) != len(trace):
        ...
        if force_axis_alignment or minimum_timestep > 0.0:
            ...
            for trace_name in trace_filter:
                ...
                if isinstance(trace, DummyTrace):
                    raise ValueError(f"Cannot import dummy trace {trace_name}")
...
def tobytes_for_trace(
    trace: Trace,
) -> Callable[[Any], bytes]:  # pylint: disable=unused-argument
    ...
    def tobytes(value: Any) -> bytes:
        ...
        return cast(bytes, value.tobytes())
