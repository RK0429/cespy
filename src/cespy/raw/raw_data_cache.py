...
class RawDataCache:
    ...
    def __init__(
        ...
        _logger.info("RawDataCache initialized with %d MB limit", max_size / 1024 / 1024)
    ...
    def _load_cache(self) -> None:
        ...
        try:
            ...
            _logger.info("Cache loaded from %s (%d entries)", 
                        self.persist_path, len(self._cache))
...
class MultiLevelCache:
    ...
    def __init__(
        ...
        _logger.info("MultiLevelCache initialized: %d MB memory, %d GB disk",
                    memory_size / 1024 / 1024, disk_size / 1024 / 1024 / 1024)
