...
class CallbackManager:
    ...
    def register(
        ...
        with self._lock:
            ...
            _logger.debug("Registered callback '%s' of type %s", callback_id, callback_type)
    ...
    def execute(
        ...
        return self._execute_callback(callback_id, callback_info, raw_file, log_file, context)
    ...
    def execute_all(
        ...
        with self._lock:
            callbacks_to_execute = [
                (cid, cinfo) for cid, cinfo in self._callbacks.items()
        ...
        for callback_id, callback_info in callbacks_to_execute:
            ...
            if not success and stop_on_error:
                _logger.warning("Stopping callback execution due to error in '%s'", callback_id)
                break
    ...
    def create_parallel(self, *callback_ids: str) -> Callable:
        ...
        def parallel_callback(raw_file: Path, log_file: Path) -> Dict[str, Tuple[bool, Any]]:
            results = {}
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                ...
                for future in concurrent.futures.as_completed(futures):
                    ...
                    try:
                        ...
                        _logger.error("Error in parallel execution of '%s': %s", callback_id, e)
    ...
    def _validate_callback(
        ...
        elif callback_type in (CallbackType.SIMPLE_FUNCTION, CallbackType.PARAMETERIZED_FUNCTION):
