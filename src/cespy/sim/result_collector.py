...
class ResultCollector:
    ...
    def add_result(
        ...
        if log_file and log_file.exists():
            try:
                ...
                _logger.warning("Failed to extract measurements from %s: %s", log_file, e)
    ...
    def export_to_csv(self, output_path: Path, batch_id: Optional[str] = None) -> None:
        ...
        with open(output_path, 'w', newline='', encoding='utf-8') as csvfile:
            # Define fields
            fields = [
                'task_id', 'netlist', 'success', 'duration', 'error_message'
        ...
        if include_files:
            ...
            for result in results:
                ...
                if result.netlist_path.exists():
                    shutil.copy2(result.netlist_path, result_dir / result.netlist_path.name)
