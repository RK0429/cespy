...
"""
        ...
        circuit.netlist = netlist.splitlines()
    ...
    def test_add_instruction(self):
        ...
        assert ".tran 1m" in str(circuit)
        
        circuit.add_instruction(".ac dec 10 1 10k")
        assert ".ac dec 10 1 10k" in str(circuit)
...
""")
    ...
    def test_encoding_detection(self, temp_dir: Path):
        ...
        assert "µ" in str(editor)
        assert "Ω" in str(editor)
...
""")
        ...
        assert "X1" in [comp.ref for comp in editor.get_components()]
...
""")
        ...
        assert any(".step param res" in line for line in editor.netlist)